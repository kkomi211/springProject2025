...
public class SmsController {
    ...
    public SmsController(
            ...
            @Value("${SMS_SECRET_KEY}") String secretKey) {
    ...
    // You can now add your SMS sending methods here
    ...
    public HashMap<String, Object> sendOne(@RequestParam("phone") String phone) {
        Message message = new Message();
        // 발신번호 및 수신번호는 반드시 01012345678 형태로 입력되어야 합니다.
        String ranStr = randomNumber();
        message.setFrom("01046548947");
        message.setTo(phone);	
        message.setText("[본인 인증] 인증 번호 " + ranStr + " 를 화면에 입력해주세요.");
