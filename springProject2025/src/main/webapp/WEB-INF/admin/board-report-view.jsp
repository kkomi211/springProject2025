<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <title>신고 게시물 상세 - RUNNERS HOUSE</title>
        ...
        <div id="app">
            ...
            <div class="content">
                ...
                <div class="detail-card">
                    ...
                    <div class="detail-item"><strong>게시글 작성자:</strong> {{ detail.boardUserId }} ({{
                        detail.boardAuthorName }})</div>
                    <div class="detail-item"><strong>신고자:</strong> {{ detail.reporterId }} ({{ detail.reporterName }})
                    </div>
                    <div class="detail-item"><strong>신고 날짜:</strong> {{ detail.cDate }}</div>
                    <div class="detail-item"><strong>처리 상태:</strong>
                        <span
                            :class="{'status-button': true, 'n': detail.reportStatus === 'N', 'y': detail.reportStatus === 'Y'}">
                ...
                <div class="detail-button-group">
                    <button @click="fnDeleteBoard()" class="btn-delete"
                        :disabled="detail.reportStatus === 'Y'">삭제</button>
                    <button @click="fnProcessReport()" class="btn-process-report"
                        :disabled="detail.reportStatus === 'Y'">처리</button>
