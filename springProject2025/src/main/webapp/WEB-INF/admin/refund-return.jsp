<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <body class="adminbody">
        <div id="app">
            ...
            <div class="content">
                ...
                <div class="search-filters">
                    ...
                    <div class="filter-group">
                        <input type="text" v-model="keyword" @keyup.enter="fnGetRefundReturnList()"
                            placeholder="상품명, 유저ID, 유저이름 검색">
            ...
            <!-- 모달 -->
            <div id="refundReturnModal" class="modal-overlay" v-if="showModal" @click.self="closeModal()">
                    ...
                    <div class="modal-body">
                        ...
                        <div v-if="selectedOrder.status === '교환요청'">
                            ...
                            <div v-if="newProductDetails">
                                ...
                                <p v-if="exchangeQuantity > newProductDetails.quantity"
                                    style="color:red; font-size:0.8rem;">재고가 부족합니다.</p>
                            </div>
                        </div>
                    </div>
