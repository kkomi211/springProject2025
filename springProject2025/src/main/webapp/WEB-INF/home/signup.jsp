                    ...
                    <div class="top-header">
                        ...
                        <div id="right-items">
                            <div>
                                ...
                                <!-- </template> -->
                                <!-- <template > -->
                                    <div><a href="/home/login.do"><i data-lucide="log-in" stroke-width="1.5"></i></a></div>
                                <!-- </template> -->
                            </div>
                            <div v-if="sessionId == ''">
                    ...
                    <div>
                        <div class="signup-container">
                            ...
                            <div class="signup-form">
                                ...
                                <div class="form-row">
                                    <label>전화번호</label>
                                    <input type="text" placeholder="- 없이 전화번호를 입력하세요" v-model="phone"
                                        @keyup.enter="fnSignup" id="phone">
                                </div>
