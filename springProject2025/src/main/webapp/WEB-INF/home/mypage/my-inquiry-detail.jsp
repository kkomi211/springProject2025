                            ...
                            <main class="main-content">
                                ...
                                <section v-if="inquiry" class="mypage-content inquiry-view">
                                    <div class="inquiry-detail order-item">
                                        ...
                                        <p>
                                            문의번호 {{ inquiry.inquiryNo }} &nbsp;&nbsp;|&nbsp;&nbsp; 문의 날짜 {{
                                            inquiry.cdate }} &nbsp;&nbsp;|&nbsp;&nbsp;
                                            문의 상품 <a href="javascript:;" @click="pageChangeProduct(inquiry.productNo)">
                                                {{inquiry.productName}} </a> &nbsp;&nbsp;|&nbsp;&nbsp;
                                            문의 상품번호 <a href="javascript:;"
                                                @click="pageChangeProduct(inquiry.productNo)"> {{inquiry.productNo}}
                                            </a>
                                        </p>
                                        <hr>
