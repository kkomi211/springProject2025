                            ...
                            <div class="order-layout">
                                    ...
                                    <div class="delivery-info-box">
                                        ...
                                        <div class="delivery-info-content">
                                            ...
                                            <textarea v-model="deliveryInfo.addr" placeholder="배송 주소를 입력하세요"
                                                class="delivery-request-input" disabled
                                ...
                                <div class="payment-summary">
                                    ...
                                    <div class="summary-total">
                                        <span>총 결제 금액</span>
                                        <span class="summary-total-amount">{{ formatCurrency(totalPaymentAmount)
                                            }}원</span>
                                    </div>
                                ...
                                <div class="order-items-list">
                                    <template v-for="(item, index) in selectedItems"
                                        ...
                                        <section class="order-item">
                                            <div
                                                style="width: 120px; height: 120px; margin-right: 20px; border: 1px solid #eee; border-radius: 4px; overflow: hidden; flex-shrink: 0; background: #f9f9f9;">
                                                <model-viewer
                                                    v-if="item.imgPath && item.imgPath.toLowerCase().endsWith('.glb')"
                                                    :src="getImagePath(item.imgPath)" auto-rotate
                                                    rotation-per-second="40deg" disable-zoom
                                                    style="width: 100%; height: 100%;">
                                                </model-viewer>

                                                <img v-else :src="getImagePath(item.imgPath)" :alt="item.productName"
                                            ...
                                            <div class="product-info">
                                                <div>
                                                    ...
                                                    <p class="product-detail">주문번호: {{ fnGenerateOrderNumber(item,
                                                        index) }}
                                                    </p>
                                                    <p class="product-price">상품 총가격 : {{
