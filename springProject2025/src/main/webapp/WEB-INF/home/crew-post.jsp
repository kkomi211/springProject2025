        ...
        const app = Vue.createApp({
            ...
            methods: {
                ...
                fnMoveToBoard: function () {
                    ...
                    location.href = "/home/community/crewBoard.do";
                },
                fnPost: function () {
                    let self = this;
                    // 제목이 비어있으면
                    ...
                    // 내용이 비어있으면
                    if (self.intro.trim() === "" || self.intro === "<p><br></p>") {
                        alert("내용을 입력해주세요.");
                    ...
                    console.log("Post intro == >" + self.intro);
                    console.log("Post keylock == >" + self.keylock);
                    let param = {
                        roomType: 'CREW',
                        ownerId: self.sessionId, // DB의 OWNER_ID
                        name: self.userName,     // DB의 NAME
                        title: self.title,
                        intro: self.intro
                    };
                    $.ajax({
            ...
            mounted() {
                ...
                quill.on('text-change', function () {
                    self.intro = quill.root.innerHTML;
                });
            }
        });
