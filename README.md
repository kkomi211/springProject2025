...
| 🧑‍💻 **아린** |  **공통 CSS (Header/Footer)** , **게시판 · 유저상세정보 · 로그인/회원가입** |  
| 👟 **전경환** | **마이페이지 작성 및 수정** ,  **결제API 및 할인적용계산**, **배송 및 문의 알림**  | 
| 🤖 **김지훈** | **관리자페이지 css · 상품 문의 · 환불/주문 취소 · 유저 관리 · 주문 내역 · 관리자 알림** | 
| 🎨 **김반석** | **메인화면 배너설정** , **대회 관리** , **크루 관리** | 
